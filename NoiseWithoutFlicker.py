...
# text2html('Now we use the full circuit for the antenna')
# img2html('Final_antenna.png', 600)

# text2html('Simulating the input referred noise of this circuit, and plotting it together with the hard limit from the antenna requirements')
# img2html('Ltspice_simulation.svg', 500)
# text2html('From this we can see that the current design is able to meet the noise requirements of the antenna, and we don\'t have a showstopper at this point')
# # calculate source referred noise spectrum
# i1.setSource('V1')
# i1.setDetector('V_out')
# i1.setGainType('vi')
