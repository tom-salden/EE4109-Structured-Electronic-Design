...
text2html("$10 kHz \implies E = 100nVm^{-1}Hz^{-1/2} \implies V = 50nVHz^{-1/2} = 2.5 * 10^{-15}V^2/Hz$ <br /> \
           $100 kHz \implies E = 10nVm^{-1}Hz^{-1/2} \implies V = 5nVHz^{-1/2} = 2.5 * 10^{-17}V^2/Hz$ <br /> \
           $1 MHz \implies E = 5nVm^{-1}Hz^{-1/2} \implies V = 2.5nVHz^{-1/2} = 6.25 * 10^{-18}V^2/Hz$ <br /> \
           $30 MHz \implies E = 5nVm^{-1}Hz^{-1/2} \implies V = 2.5nVHz^{-1/2} = 6.25 * 10^{-18}V^2/Hz$")
text2html("Like visible from these requirements, the noise floor cutoff frequency is at around $100 kHz$ and the E-field noise density limit at the noise floor is $5nVm^{-1}Hz^{-1/2}$")
text2html("From the model, the E-field noise can be converted to a voltage, $V = 0.5 \cdot 5nVm^{-1}Hz^{-1/2} = 2.5nVHz^{-1/2}$")
