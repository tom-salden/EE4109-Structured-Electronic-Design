...
text2html('The total active antenna should have a gain of 1, so the value of the capacitor should have the value of $\ell * C_A$, so ' + str(globalVariables.l) + '*' + str(globalVariables.Ca) + ' = ' + str(globalVariables.l*globalVariables.Ca*1e12) + ' pF.')
